...
// Tablicę dwuwymiarową o 3 kolumnach i 3 wierszach.
...
// zwracającą symbol gracza którego 3 znaki znajdują się w wierszu,
...
// znak(A, B lub C), liczbę całkowitą(1,2 lub 3).
